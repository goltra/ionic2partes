...
function rollupWorker(context, configFile) {
    return new Promise(function (resolve, reject) {
        ...
        rollupBundler.rollup(rollupConfig).then(function (bundle) {
...
function clearCachedModule(context, id) {
    if (cachedBundle) {
        var cachedModule = cachedBundle.modules.find(function (m) { return m.id === id; });
        if (cachedModule) {
            var index = cachedBundle.modules.indexOf(cachedModule);
            if (index > -1) {
    ...
    logger_1.Logger.debug("clearCachedModule: no existing context.cachedBundle to clear");
    return false;
}
