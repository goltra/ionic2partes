...
export const MyAppNgFactory:import12.ComponentFactory<import3.MyApp> = new import12.ComponentFactory<import3.MyApp>('ng-component',viewFactory_MyApp_Host0,import3.MyApp);
...
class _View_MyApp0 extends import1.AppView<import3.MyApp> {
  ...
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _Menu_0_4:import14.Menu;
  _query_Content_0_0:import13.QueryList<any>;
  _text_1:any;
  _el_2:any;
  /*private*/ _appEl_2:import2.AppElement;
  _Toolbar_2_4:import15.Toolbar;
  _text_3:any;
  _el_4:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = import21.viewFactory_Menu0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    var compView_2:any = import27.viewFactory_Toolbar0(this.viewUtils,this.injector(2),this._appEl_2);
    this._Toolbar_2_4 = new import15.Toolbar(this.parentInjector.get(import28.ViewController,(null as any)),this.parentInjector.get(import23.Config),new import22.ElementRef(this._el_2),this.renderer);
    ...
    this._ToolbarTitle_4_4 = new import16.ToolbarTitle(this.parentInjector.get(import23.Config),new import22.ElementRef(this._el_4),this.renderer,this._Toolbar_2_4,this.parentInjector.get(import30.Navbar,(null as any)));
    ...
    this._Content_8_4 = new import17.Content(this.parentInjector.get(import23.Config),new import22.ElementRef(this._el_8),this.renderer,this.parentInjector.get(import32.App),this.parentInjector.get(import24.Keyboard),this.parentInjector.get(import25.NgZone),this.parentInjector.get(import28.ViewController,(null as any)),this.parentInjector.get(import33.Tabs,(null as any)));
    ...
    this._List_10_3 = new import18.List(this.parentInjector.get(import23.Config),new import22.ElementRef(this._el_10),this.renderer,this.parentInjector.get(import26.GestureController));
    ...
    this._TemplateRef_12_5 = new import34.TemplateRef_(this._appEl_12,viewFactory_MyApp1);
    this._NgFor_12_6 = new import19.NgFor(this._appEl_12.vcRef,this._TemplateRef_12_5,this.parentInjector.get(import35.IterableDiffers),this.ref);
    ...
    this._query_Content_0_0.reset([this._Content_8_4]);
    ...
    var compView_17:any = import36.viewFactory_Nav0(this.viewUtils,this.injector(17),this._appEl_17);
    this._Nav_17_4 = new import20.Nav(this.parentInjector.get(import28.ViewController,(null as any)),this.parentInjector.get(import37.NavControllerBase,(null as any)),this.parentInjector.get(import32.App),this.parentInjector.get(import23.Config),this.parentInjector.get(import24.Keyboard),new import22.ElementRef(this._el_17),this.parentInjector.get(import25.NgZone),this.renderer,this.parentInjector.get(import38.ComponentFactoryResolver),this.parentInjector.get(import26.GestureController),this.parentInjector.get(import39.TransitionController),this.parentInjector.get(import40.DeepLinker,(null as any)));
    this._appEl_17.initComponent(this._Nav_17_4,([] as any[]),compView_17);
    compView_17.create(this._Nav_17_4,([] as any[]),(null as any));
    this._expr_0 = import7.UNINITIALIZED;
    this._expr_1 = import7.UNINITIALIZED;
    this._expr_2 = import7.UNINITIALIZED;
    this._expr_3 = import7.UNINITIALIZED;
    this._expr_4 = import7.UNINITIALIZED;
    this._viewQuery_Nav_0.reset([this._Nav_17_4]);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import15.Toolbar) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 6)))) { return this._Toolbar_2_4; }
    ...
    if (((token === import18.List) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 13)))) { return this._List_10_3; }
    if (((token === import17.Content) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 14)))) { return this._Content_8_4; }
    if (((token === import14.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._Menu_0_4; }
    if (((token === import20.Nav) && (17 === requestNodeIndex))) { return this._Nav_17_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changed = false;
    const currVal_0:any = this._Nav_17_4;
    ...
    const currVal_2:any = this._Content_8_4._sbPadding;
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this.renderer.setElementClass(this._el_8,'statusbar-padding',currVal_2);
      this._expr_2 = currVal_2;
    }
    this.detectViewChildrenChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._Nav_17_4.ngAfterViewInit(); } }
  }
...
class _View_MyApp1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Item_0_4 = new import41.Item(this.parent.parentInjector.get(import43.Form),this.parent.parentInjector.get(import23.Config),new import22.ElementRef(this._el_0),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import41.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._Item_0_4; }
    if (((token === import41.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._ItemContent_0_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
