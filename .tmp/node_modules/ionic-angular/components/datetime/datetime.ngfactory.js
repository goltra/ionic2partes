...
var _View_DateTime_Host0 = (function (_super) {
    ...
    function _View_DateTime_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_DateTime_Host0, renderType_DateTime_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    Object.defineProperty(_View_DateTime_Host0.prototype, "_NG_VALUE_ACCESSOR_0_5", {
        get: function () {
            if ((this.__NG_VALUE_ACCESSOR_0_5 == null)) {
                (this.__NG_VALUE_ACCESSOR_0_5 = [this._DateTime_0_4]);
            }
    ...
    _View_DateTime_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._DateTime_0_4 = new import3.DateTime(this.parentInjector.get(import8.Form), this.parentInjector.get(import9.Config), new import10.ElementRef(this._el_0), this.renderer, this.parentInjector.get(import11.Item, null), this.parentInjector.get(import12.PickerController, null));
    ...
    _View_DateTime_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.DateTime) && (0 === requestNodeIndex))) {
            return this._DateTime_0_4;
        }
    ...
    _View_DateTime_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (!throwOnChange) {
            if ((this.numberOfChecks === 0)) {
                this._DateTime_0_4.ngAfterContentInit();
            }
        }
        var currVal_2 = this._DateTime_0_4._disabled;
    ...
    _View_DateTime_Host0.prototype._handle_click_0_0 = function ($event) {
        ...
        var pd_0 = (this._DateTime_0_4._click($event) !== false);
        return (true && pd_0);
    };
    _View_DateTime_Host0.prototype._handle_keyup_space_0_1 = function ($event) {
        this._appEl_0.componentView.markPathToRootAsCheckOnce();
        var pd_0 = (this._DateTime_0_4._keyup() !== false);
        return (true && pd_0);
    };
...
export var DateTimeNgFactory = new import15.ComponentFactory('ion-datetime', viewFactory_DateTime_Host0, import3.DateTime);
var styles_DateTime = [];
...
var _View_DateTime0 = (function (_super) {
    ...
    function _View_DateTime0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_DateTime0, renderType_DateTime, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    ...
    _View_DateTime0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_0 = import4.interpolate(1, '', this.context._text, '');
...
export function viewFactory_DateTime0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_DateTime === null)) {
        (renderType_DateTime = viewUtils.createRenderComponentType('/Users/franciscogarcia/Documents/angular2/ionic2partes-rc/node_modules/ionic-angular/components/datetime/datetime.d.ts class DateTime - inline template', 0, import14.ViewEncapsulation.None, styles_DateTime, {}));
    }
